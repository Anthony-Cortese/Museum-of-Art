...
interface HeaderInterface {
 ...
 function Header(props: HeaderInterface) {
    ...
    const artists = useSelector(selectArtwork);
                   ...
                   onClick={() => {
                      homeRef
                         ? homeRef.current?.scrollTo({
                              behavior: "smooth",
                              top: art.ref?.offsetTop,
                           })
                         : navigation(`/art/${art.id}`);
                   }}
                   key={art.id}
                >
                   {art.artist}
 ...
 const CustomMenu = styled(HiOutlineMenuAlt1)`
    cursor: pointer;
 `;
 ...
 const CustomClose = styled(HiOutlineMenuAlt1)`
    cursor: pointer;
 `;
